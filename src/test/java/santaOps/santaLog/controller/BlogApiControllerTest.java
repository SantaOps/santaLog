...
class BlogApiControllerTest {
    ...
    @DisplayName("Add Article: 글 추가 성공")
    @Test
    ...
    @DisplayName("findAllArticles: 블로그 모든 글 조회")
    @Test
    ...
    @DisplayName("findOneArticle: 특정 글 조회 성공")
    @Test
    ...
    public void updateArticle() throws Exception{
        ...
        Article request = new Article(newTitle, newContent);
